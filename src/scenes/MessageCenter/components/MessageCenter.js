...
export default class MessageCenter extends Component {
    ...
    render() {
        const { me, item, chats, unreadMessages } = this.props;
            ...
            >
                ...
                <View style={styles.chatInfoContainer}>
                    <View style={styles.chatPostContainer}>
                        <Text style={styles.name}>{chatPartner.fullName}</Text>
...
const ItemImage = ({ images }) => {
    ...
    if (imageSource) {
        ...
        return <FAIcon size={font.SIZE_NORMAL} color={colors.GREY} name={'picture-o'} />;
    }
};
