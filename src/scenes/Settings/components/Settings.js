        ...
        <View>
          ...
          <View style={styles.field}>
            ...
            <View style={[
              ...
              styles.inputContainerFixedWidth,
            ]}>
              <Picker
                style={styles.input}
              ...
              >
                {Object.keys(LOCALES).map(key =>
                  <Picker.Item key={key} label={LOCALES[key].label} value={LOCALES[key].value} />
                )}
              </Picker>
            </View>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <Text style={styles.label}>
                {t(dictionary.measureDistanceBy)}
              </Text>
            </View>
            <View style={[
              styles.inputContainer,
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <Text style={styles.label}>
                {t(dictionary.showMeThingsWithin)}
              </Text>
            </View>
            <View style={[
              styles.inputContainer,
              ...
              >
                <Picker.Item label={'10' + settings.radiusUnit.toUpperCase()} value={10} />
                <Picker.Item label={'20' + settings.radiusUnit.toUpperCase()} value={20} />
                <Picker.Item label={'30' + settings.radiusUnit.toUpperCase()} value={30} />
                <Picker.Item label={'40' + settings.radiusUnit.toUpperCase()} value={40} />
                <Picker.Item label={'50' + settings.radiusUnit.toUpperCase()} value={50} />
              </Picker>
            </View>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <Text style={styles.label}>
                {t(dictionary.pushNotifications)}
              </Text>
            </View>
            ...
            <View style={styles.inputContainer}>
              <Switch
                style={styles.input}
                onValueChange={isNotificationOn => updateMySettings({ isNotificationOn })}
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <Text style={styles.label}>
                {t(dictionary.playSoundsWithinTheApp)}
              </Text>
            </View>
          ...
          <TouchableOpacity onPress={() => this.props.changeScene(SCENES.privacyPolicy.key)}>
          ...
          <TouchableOpacity onPress={() => this.props.changeScene(SCENES.termsConditions.key)}>
            <View style={styles.link}>
              <View style={styles.linkLabel}>
