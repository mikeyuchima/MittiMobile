...
export const CREATE_QUESTION_SCENE_SET_QUESTION_CATEGORY_ID = 'CREATE_QUESTION_SCENE_SET_QUESTION_CATEGORY_ID';
...
export const createQuestion = () => {
  return (dispatch, getState) => {
    const {categoryId: category, form: {question, address}, position} = getState().createQuestionScene;
    ...
    return questionApi.create(token, data)
