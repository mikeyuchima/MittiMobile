...
export const SCHEDULE_CENTER_SCENE_GET_MESSAGES_SUCCESS = 'SCHEDULE_CENTER_SCENE_GET_MESSAGES_SUCCESS';
...
export const getChats = (messages) => {
  return (dispatch, getState) => {
    ...
    return meApi.findChats(token)
      ...
      .then(
        (chats) => {
          const appointmentChats = chats.rows && chats.rows.filter((aChat) => {
