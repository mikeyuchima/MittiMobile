...
import {
	...
	removeImage,
	onMessage
} from "../../modules/app/appActions.js";
...
class CreatePostContainer extends Component {
	...
	render() {
		...
		const isFormCompleted =
			form.title && form.description && form.condition && form.address && imageUpload.imageDataList.length > 0;
		...
		return (
			<View style={(Platform.OS === 'ios') ? commonStyles.fullScreenIos : commonStyles.fullScreen}>
				<CreatePost
					me={me}
