            ...
            <View style={styles.buttonsContainer}>
              <CustomButton
                style={[
                  ...
                  styles.conditionButtonWithGap,
                ]}
                label={t(dictionary.new)}
                borderColor={colors.GREY}
                backgroundColor={this._getButtonBackgroundColor(form.condition == 'new')}
              ...
              <CustomButton
                ...
                borderColor={colors.GREY}
                backgroundColor={this._getButtonBackgroundColor(form.condition == 'used')}
