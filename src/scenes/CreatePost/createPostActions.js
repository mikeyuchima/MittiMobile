...
export const CREATE_POST_SCENE_GET_GEOCODE_DATA_SUCCESS = 'CREATE_POST_SCENE_GET_GEOCODE_DATA_SUCCESS';
...
export const CREATE_POST_SCENE_SET_CURRENT_LOCATION_SUCCESS = 'CREATE_POST_SCENE_SET_CURRENT_LOCATION_SUCCESS';
export const CREATE_POST_SCENE_SET_CURRENT_LOCATION_ERROR = 'CREATE_POST_SCENE_SET_CURRENT_LOCATION_ERROR';
...
export const createPost = (address) => {
  return (dispatch, getState) => {
    const {postType: type, form: {title, description, condition, address}, position} = getState().createPostScene;
    ...
    return postApi.create(token, data)
