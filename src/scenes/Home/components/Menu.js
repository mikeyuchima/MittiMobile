  ...
  render() {
    ...
    return (
      <View style={styles.menuContainer}>
        {_renderMenu(me, unreadMessages, changeScene)}
      </View>
    );
  }
}
...
const _renderMenu = (me, unreadMessages, changeScene) => {
  const newMessagesCount = me &&
                           me.stats &&
                           me.stats.newMessagesCount ||
                           0;
  const confirmedSchedulesCount = me &&
                                  me.stats && 
                                  me.stats.confirmedSchedulesCount || 
                                  0;
  const myActiveFreesharesCount = me &&
                                  me.stats &&
                                  me.stats.myActiveFreesharesCount || 
                                  0;
  const menuItems = [
    {
      id: 'newMessage',
    ...
    },
    {
      ...
      color: '#FFFFFF',
      iconName: 'gift',
      onPress: () => changeScene(SCENES.myPosts.key, {
        navigationParams: {
          marketType: 'free',
        },
      }),
          ...
          <View style={styles.rowContent}>
            ...
            <View style={styles.textContainer}>
              <View style={styles.labelContainer}>
                <Text style={{color: aMenuItem.color}}>
                  {aMenuItem.label}
                </Text>
              </View>
