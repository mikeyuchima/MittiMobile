...
export const CHAT_SCENE_SEND_APPOINTMENT_REQUEST_SUCCESS =
    'CHAT_SCENE_SEND_APPOINTMENT_REQUEST_SUCCESS';
export const CHAT_SCENE_SEND_APPOINTMENT_REQUEST_ERROR =
...
export const readMessages = (itemId, chatId) => {
    return (dispatch, getState) => {
        ...
        return postApi
            .readMessages(token, itemId, chatId)
            .then(resp => dispatch(appActions.processApiResponse(resp)))
            .then(messages => {
                dispatch({
...
export const sendMessage = (senderId, itemId, chatId, messageText) => {
    return (dispatch, getState) => {
        ...
        return postApi
            .createMessage(token, itemId, chatId, messageText)
            .then(resp => dispatch(appActions.processApiResponse(resp)))
            .then(message => {
                dispatch({
...
export const acceptAppointment = (itemId, chatId) => {
    return (dispatch, getState) => {
        ...
        return postApi
            .confirmSchedule(token, itemId, chatId)
            .then(resp => dispatch(appActions.processApiResponse(resp)))
            .then(chat => {
                dispatch({
...
export const sendAppointmentRequest = (itemId, chatId, timeRequested) => {
    return (dispatch, getState) => {
        ...
        return postApi
            .schedule(token, itemId, chatId, timestamp)
            .then(resp => dispatch(appActions.processApiResponse(resp)))
            .then(chat => {
                dispatch({
