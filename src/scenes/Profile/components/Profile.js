        ...
        <View style={mittiStyles.bottomScrollExtra}>
          <View style={styles.profileButton}>
            ...
            <View style={styles.usernameContainer}>
              ...
              {isEditable ? (
                <TouchableOpacity onPress={() => toggleEditMode(true)} style={styles.editButton}>
                  <MCIIcon size={font.SIZE_H1} color={colors.DARK_GREY} name={'pencil'} />
                </TouchableOpacity>
              ) : null}
            </View>
          </View>
          ...
          <View style={styles.fieldContainer}>
            <View style={styles.iconContainer}>
              <FAIcon size={font.SIZE_ICON} color={colors.DARK_GREY} name={'envelope'} />
            </View>
              ...
              {userPhone && !isPhonePublic ? (
                <View style={styles.badgeContainer}>
                  <View style={styles.badgeIconContainer}>
                    <MCIIcon size={font.SIZE_SMALL} color={colors.DARK_GREY} name={'eye'} />
                  </View>
                  <View style={styles.badgeLabelContainer}>
                    <Text style={styles.badgeLabel}>{t(dictionary.onlyMe).toUpperCase()}</Text>
                  </View>
                </View>
              ) : null}
            </View>
