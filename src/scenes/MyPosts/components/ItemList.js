...
export default class ItemList extends Component {
  ...
  render() {
    ...
    let currentItemList = items.rows && items.rows.map((anItem) => {
      const inquiries = chats.rows && chats.rows.filter((aChat) => {
    ...
    return (
      <View style={[
        ...
        {
          currentItemList && currentItemList.map((anItem) => 
            <ListItem 
              key={anItem._id} 
        ...
        {isFetchingItems && <View style={commonStyles.centeredChilds}><Spinner color={'black'} /></View>}
      </View>
    );
  }
}
