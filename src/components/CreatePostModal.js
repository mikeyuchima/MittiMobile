        ...
        <View style={[
          ...
          <View style={[
            ...
            <View style={styles.topContainer}>
              <TouchableOpacity 
                onPress={() => this._showCreateForm(SCENES.createPost.key, POST_TYPES.free.id)}
            ...
            <View style={styles.bottomContainer}>
              <TouchableOpacity
                onPress={() => this._showCreateForm(SCENES.createQuestion.key, 'question')}
